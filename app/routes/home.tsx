...
export default function Home() {
  return (
    <div className="flex overflow-hidden">
      ...
      <div className="relative shrink-0 mx-auto flex h-dvh flex-col justify-between w-[80vw] lg:w-3xl">
        <div className="relative p-8 text-xl font-medium tracking-tighter border_after">
        ...
        <div className="flex h-full flex-col text-[10vw] font-light tracking-tighter *:flex *:items-center *:py-6 md:text-[8vh] divide-y">
          {[
            ...
            <Link
              key={i}
              className="relative group/link h-full flex items-center overflow-hidden  hover:bg-foreground hover:text-background transition-colors duration-500"
              to={item.href}
            >
