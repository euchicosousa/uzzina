    ...
    input: [
      {
        ...
        IMPORTANTE: Você deve usar o texto como base, mas nunca apenas repetir o que foi dito. identifique o ponto mais forte e a CTA para reforçar. Se for necessário pode solicitar ao usuário que confirme se o ponto forte do texto foi bem ressaltado.
