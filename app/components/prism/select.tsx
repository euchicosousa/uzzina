...
function SelectItem({
  ...
  return (
    <ListBoxItemPrimitive
      className={cn(
        "relative flex min-h-7 squircle w-full cursor-default items-center gap-2 rounded-xl py-1.5 pr-12 pl-2 text-sm outline-hidden select-none focus:bg-secondary/50 focus:text-foreground data-focused:bg-secondary/50 data-focused:text-foreground data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
        className,
      )}
